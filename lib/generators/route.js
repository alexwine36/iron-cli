...
var RouteGenerator = Generator.create({
  ...
  var destpathS = this.rewriteDestinationPathForEngine(this.pathFromApp('server/security.js'));
  var contentS = this.templateContent('security/security.js', securityContext);
  this.injectAtEndOfFile(destpathS, '\n' + contentS);
